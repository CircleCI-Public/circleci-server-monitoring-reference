...
| prometheus.serviceMonitor.selectorExpressions | list | `[{"key":"app.kubernetes.io/name","operator":"In","values":["tempo","opentelemetry-collector","tempo"]}]` | Match ServiceMonitors with specific names |
